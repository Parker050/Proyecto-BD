            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <div class="float">
                            <a href="../base_V_Digitales.php" class="btn btn-secondary btn-back">Regresar</a>
                        </div>
                    </div>
                    <?php
                    // Include config file
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>" . "<a href ='../insertar_ventas/insert_VD.php?id=".$row['idVuelo']."' class='btn btn-primary'>COMPRAR</a>" . "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
                            echo "</table>";
